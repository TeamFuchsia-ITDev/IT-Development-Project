        ...
        <>
            ...
            <div className="ml-4 mr-4 mt-24">
                <div className="ml-4 mr-4">
                    ...
                    <p className="text-[20px] w-[900px] ">In here you will be able to fill up and post requests you need help with </p>
                </div>

                <div className="flex flex-col items-center">
                    <p className="text-center underline underline-offset-8 decoration-rose-500 decoration-2 mt-24">Request Form</p>
                    ...
                    <div className="flex flex-col w-[700px] border-2 mt-4 items-center mb-12 shadow-lg" >
                        ...
                        <div className="flex flex-col">
                            ...
                            />
                            <p className="flex items-center text-[20px] justify-center mb-12">Name</p>
                        </div>

                        <div className="flex flex-col w-[400px] gap-4 ">
                            <p className="text-[13px]">Task Name</p>
                            <input type="text" placeholder="" className="border-2 border-gray-300 h-[45px]  " />

                            <p className="text-[13px]">Category</p>
                            <select className="border-2 border-gray-300  h-[45px] "
                                id="categories"
                                name="categories"
                            ...
                            <input type="Datetime-local" placeholder="" className="border-2 border-gray-300 h-[45px] " />

                            <p className="text-[13px]">Brief Description of the task</p>
                            <textarea placeholder="" className="border-2 border-gray-300 h-[150px] resize-none " />
                            <p className="text-[10px]"><a className="text-rose-600">Note:</a> Once request is posted, your profile details will be shown to the companions once they viewed the request.</p>
                            <button
