            ...
            <div className="ml-4 mr-4 mt-24">
                ...
                <div className="flex flex-col items-center mt-4">
                    <div className="flex flex-col w-[500px] border-2 mt-4 items-center mb-12 shadow-lg ">
                        ...
                        <button
                            className="text-center bg-rose-500 text-white font-bold mb-8 rounded h-[45px] w-[400px] hover:bg-white hover:text-rose-500 hover:border-[2px] hover:border-rose-500 hover:ease-in-out duration-300"
