  ...
  const registerUser = async (e: FormEvent) => {
    ...
    try {
      ...
      if (response.data.status !== 200) {
        ...
        setTimeout(() => toast.loading("Redirecting now to the login page...", {
			duration: 4000
		}), 1000);
        setTimeout(() => {
          toast.dismiss();
      ...
      <div className="flex flex-row ">
        ...
        <div className="flex flex-col justify-center m-auto w-[400px]">
          <div className="">
            ...
            <h1 className="text-4xl font-bold text-center mb-2 mt-4">Sign up</h1>
            <p className="text-center mb-6">Create free account now and start meeting others</p>
            ...
            <div className="flex flex-col">
              ...
              <input type="text" placeholder="" className="border-2 border-gray-300  h-[45px] m-2" id="name"
                name="name"
                type="text"
                //   required
                value={data.name}
              ...
              <input type="text" placeholder="" className="border-2 border-gray-300  h-[45px] m-2"
                id="email"
                name="email"
                type="email"
                autoComplete="email"
              ...
              <input type="password" placeholder="" className="border-2 border-gray-300 h-[45px]  m-2"
             ...
             //   required
              ...
              <div className="flex flex-row justify-center mt-6 m-auto mb-8">
                <input type="checkbox" className="mr-2 ml-2 mt-[0.9px]" id="rules"/>
                <p className="text-center text-[13px] ">By signing up, you agree with the<a href="rules" className="text-purple-700"> terms and rules </a>of using this platform. If you already have an account <a href="/login" className="text-purple-700">Sign in</a></p>
              </div>
              <div className="flex flex-col  items-center">

                <button className="text-center bg-rose-500 text-white font-bold w-[385px] rounded h-[45px] hover:bg-white hover:text-rose-500 hover:border-[2px] hover:border-rose-500 hover:ease-in-out duration-300" onClick={registerUser}>Sign up</button>
              </div>
